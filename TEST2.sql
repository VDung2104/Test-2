...
('HD02', '2022-10-15', 'DO THI NGOC BICH');
...
-- CAU 2
SELECT TOP 1
MAHD, SUM(SLBAN * DONGIA) AS N'Tong Tien'
FROM HANGXUAT
GROUP BY MAHD
...
RETURN
    SELECT 
        ...
        HX.SLBAN,  
        CASE
            WHEN WEEKDAY(HD.NGAYXUAT) = 0 THEN N'Thu hai'            
            WHEN WEEKDAY(HD.NGAYXUAT) = 1 THEN N'Thu ba'
            WHEN WEEKDAY(HD.NGAYXUAT) = 2 THEN N'Thu tu'
            WHEN WEEKDAY(HD.NGAYXUAT) = 3 THEN N'Thu nam'
            WHEN WEEKDAY(HD.NGAYXUAT) = 4 THEN N'Thu sáu'
            WHEN WEEKDAY(HD.NGAYXUAT) = 5 THEN N'Thu bay'
            ELSE N'Chu nhat'
        END AS NGAYTHU
    FROM HANGXUAT HX
